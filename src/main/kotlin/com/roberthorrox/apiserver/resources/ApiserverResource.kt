package com.roberthorrox.apiserver.resources
...
import com.roberthorrox.apiserver.api.Saying

@Path("/hello-world")
@Produces(MediaType.APPLICATION_JSON)
class ApiserverResource(val template: String, val defaultName: String) {
